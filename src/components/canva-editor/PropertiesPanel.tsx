          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 6 }}>
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 6 }}>
              <div>
                ...
                <input type="number" min={8} max={300} value={element.buttonStyle.fontSize}
                  onChange={(e) => onUpdate({ buttonStyle: { ...element.buttonStyle!, fontSize: Number(e.target.value) } })}
                  style={inputStyle} />
              </div>
              <div>
                <span style={labelStyle}>Weight</span>
                <select value={element.buttonStyle.fontWeight}
            ...
            <div>
              ...
              <div style={{ display: 'flex', gap: 6, alignItems: 'center' }}>
                <input type="color" value={element.buttonStyle.textColor.startsWith('rgba') ? '#ffffff' : element.buttonStyle.textColor}
                  onChange={(e) => onUpdate({ buttonStyle: { ...element.buttonStyle!, textColor: e.target.value } })}
                  style={{ width: 28, height: 28, border: 'none', borderRadius: 4, cursor: 'pointer', padding: 0, backgroundColor: 'transparent' }} />
                <input type="text" value={element.buttonStyle.textColor}
                  onChange={(e) => onUpdate({ buttonStyle: { ...element.buttonStyle!, textColor: e.target.value } })}
                  style={{ ...inputStyle, flex: 1 }} />
              </div>
            </div>
            <div>
              ...
              <input type="text" value={element.buttonStyle.backgroundColor}
            ...
            <div>
              ...
              <input type="number" min={0} value={element.buttonStyle.borderRadius}
        ...
        <>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 6 }}>
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 6 }}>
              <div>
                <span style={labelStyle}>Font Size</span>
                <input type="number" min={8} max={300} value={element.badgeStyle.fontSize}
                  onChange={(e) => onUpdate({ badgeStyle: { ...element.badgeStyle!, fontSize: Number(e.target.value) } })}
                  style={inputStyle} />
              </div>
              <div>
                <span style={labelStyle}>Weight</span>
                <select value={element.badgeStyle.fontWeight}
            ...
            <div>
              <span style={labelStyle}>Text Color</span>
              <input type="text" value={element.badgeStyle.textColor}
                onChange={(e) => onUpdate({ badgeStyle: { ...element.badgeStyle!, textColor: e.target.value } })}
                style={inputStyle} />
            </div>
            <div>
              <span style={labelStyle}>Background</span>
              <input type="text" value={element.badgeStyle.backgroundColor}
        ...
        <>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 6 }}>
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 6 }}>
              <div>
                <span style={labelStyle}>Font Size</span>
                <input type="number" min={8} max={300} value={element.stripStyle.fontSize}
                  onChange={(e) => onUpdate({ stripStyle: { ...element.stripStyle!, fontSize: Number(e.target.value) } })}
                  style={inputStyle} />
              </div>
              <div>
                <span style={labelStyle}>Weight</span>
                <select value={element.stripStyle.fontWeight}
            ...
            <div>
              <span style={labelStyle}>Text Color</span>
              <input type="text" value={element.stripStyle.textColor}
                onChange={(e) => onUpdate({ stripStyle: { ...element.stripStyle!, textColor: e.target.value } })}
                style={inputStyle} />
            </div>
            <div>
              <span style={labelStyle}>Background</span>
              <input type="text" value={element.stripStyle.backgroundColor}
