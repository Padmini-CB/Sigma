...
export const TEMPLATES: TemplateInfo[] = [
  // ── A — "YOUR TODOS DON'T SHIP." ──
  {
    ...
    createElements: () => [
      ...
      makeImage({ x: 460, y: 40, width: 620, height: 780, src: '/images/bootcamps/ai-engineering/heroes/dhaval-superhero.png', maskType: 'radial', maskParams: 'ellipse 60% 55% at center 40%, black 20%, transparent 90%', glowColor: '#3b82f6', zIndex: 5 }),
  ...
  // ── E — "BUILD." ──
  {
    ...
    createElements: () => [
      ...
      makeImage({ x: 190, y: 60, width: 700, height: 560, src: '/images/bootcamps/ai-engineering/heroes/dhaval-superhero.png', maskType: 'radial', maskParams: 'ellipse 60% 55% at center 40%, black 20%, transparent 90%', glowColor: '#3b82f6', zIndex: 5 }),
      // Instructor line
  ...
  // ── I — "TWO BOOTCAMPS. ONE PRICE." ──
  {
    ...
    createElements: () => [
      ...
      makeImage({ x: 560, y: 40, width: 520, height: 600, src: '/images/bootcamps/ai-engineering/heroes/dhaval-superhero.png', maskType: 'radial', maskParams: 'ellipse 60% 55% at center 40%, black 20%, transparent 90%', glowColor: '#3b82f6', zIndex: 4 }),
