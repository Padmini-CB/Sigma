...
export default function WhySigmaSection() {
  return (
    <section className="relative py-20 sm:py-28 overflow-hidden">
      ...
      {/* Decorative elements */}
      <div className="absolute top-0 left-0 w-64 h-64 bg-brand-purple/5 rounded-full blur-3xl" />
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <blockquote className="relative">
            ...
            <div className="pl-8 sm:pl-12">
              <p className="font-body text-xl sm:text-2xl md:text-3xl text-gray-700 leading-relaxed mb-8">
              ...
              <footer className="flex items-center gap-4">
                ...
                <div>
                  <cite className="font-ui font-semibold text-brand-navy not-italic">
                    Padmini
                  </cite>
                  <p className="font-body text-sm text-gray-500">Creator of Sigma</p>
                </div>
              </footer>
            </div>
          </blockquote>
