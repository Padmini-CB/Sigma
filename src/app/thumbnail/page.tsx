...
const EXPRESSIONS = [
  ...
  { id: 'eurekamoment', label: 'Eureka Moment', img: '/assets/founders/dhaval-eurekamoment-new-nobg.png' },
  { id: 'excited-new', label: 'Excited (New)', img: '/assets/founders/dhaval-excited-new-nobg.png' },
  { id: 'frustrated', label: 'Frustrated', img: '/assets/founders/dhaval-frustrated-new-nobg.png' },
  { id: 'happy', label: 'Happy', img: '/assets/founders/dhaval-happy-new-nobg.png' },
  { id: 'holding', label: 'Holding', img: '/assets/founders/dhaval-holding-new-nobg.png' },
  { id: 'holdingatool', label: 'Holding a Tool', img: '/assets/founders/dhaval-holdingatool-new-nobg.png' },
  { id: 'money', label: 'Money', img: '/assets/founders/dhaval-money-new-nobg.png' },
  { id: 'pointingdown', label: 'Pointing Down', img: '/assets/founders/dhaval-pointingdown-new-nobg.png' },
  { id: 'pointingtoscreen', label: 'Pointing to Screen', img: '/assets/founders/dhaval-pointingtoscreen-new-nobg.png' },
  { id: 'scratchinghead', label: 'Scratching Head', img: '/assets/founders/dhaval-scratchinghead-new-nobg.png' },
  { id: 'showinghand', label: 'Showing Hand', img: '/assets/founders/dhaval-showinghand-new-nobg.png' },
  { id: 'thinking-new', label: 'Thinking (New)', img: '/assets/founders/dhaval-thinking-new-nobg.png' },
  { id: 'thinkingdeep', label: 'Thinking Deep', img: '/assets/founders/dhaval-thinkingdeep-new-nobg.png' },
  { id: 'thumbsup', label: 'Thumbs Up', img: '/assets/founders/dhaval-thumbsup-new-nobg.png' },
  { id: 'working', label: 'Working', img: '/assets/founders/dhaval-working-new-nobg.png' },
